...
// Componente de ProtecciÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n de Rutas
...
function AppContent() {
  ...
  const navItems = [
    ...
    { path: '/psychologist', label: 'PsicÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³logos', roles: ['psychologist'] },
